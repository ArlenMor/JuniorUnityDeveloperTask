...
namespace UI
{
    ...
    //Класс для работы с всплывающиим окном
    public class InfoPanelController : MonoBehaviour
    {
        ...
        //Выводи в текстовое поле имя тайла, который находит в левом верхнем углу экрана
        private void LeftTopTileInfo()
        {
            ...
            //проверяем, если точка входит в пределы тайла, то выводим его имя
